    ...
    <div style="width:40%; margin: 25px auto" >
        <form action="/profile/address/edition"  method="post">
            ...
            <div class="form-group">
                ...
                <input value="${address.street!}" type="" class="form-control form-control-lg" id="street" name="street"  required="true">
                <span class="text-danger"><@spring.showErrors ""/></span>
            </div>
            ...
            <div class="form-group">
                ...
                <input value="${address.building!}" type="number" class="form-control form-control-lg" id="building" name="building" required="true">
                <span class="text-danger"><@spring.showErrors ""/></span>
            </div>
            ...
            <div class="form-group">
                ...
                <input value="${address.room!}" type="number" class="form-control form-control-lg" id="room" name="room" required="true">
                <span class="text-danger"><@spring.showErrors ""/></span>
            </div>
            ...
            <input hidden type="text" name="customerAddressId" value="${address.customerAddressId}">
